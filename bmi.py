...
# icon
image_icon = PhotoImage(file="icon.png")  # Make sure "Images/icon.png" exists
root.iconphoto(False, image_icon)

# top
top = PhotoImage(file="top.png")  # Make sure "Images/top.png" exists
...
# two boxes
box = PhotoImage(file="box.png")  # Make sure "Images/box.png" exists
Label(root, image=box).place(x=20, y=100)
Label(root, image=box).place(x=240, y=100)

# scale
scale = PhotoImage(file="scale.png")  # Make sure "Images/scale.png" exists
...
def get_current_value2():
    return '{:.1f}'.format(current_value2.get())
...
weight = Entry(root, textvariable=Weight, width=5, font='arial 50', bg="#fff", fg="#000", bd=0, justify=CENTER)  # to align text in
