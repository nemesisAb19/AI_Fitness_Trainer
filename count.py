...
def launch_gui():
    ...
    #         # Run each exercise one by one in order
    ...
    #             "Situps": "crunch.py",
    #             "Squat": "squat.py",
    #             "Bicepcurls": "bicep_curl.py",  # add your file names as needed
    #             # Add more mappings here
    #             }.get(exercise)

    #             if script_name:
    #                 subprocess.call(["python", script_name, str(sets), str(reps), str(rest)])
    ...
    #         print(f"Sets: {sets}, Reps: {reps}, Rest: {rest} seconds")
    ...
    #             if script:
    #                 subprocess.call(["python", script, str(sets), str(reps), str(rest)])
    #                 if i != len(selected) - 1:
    ...
    prev_btn = tk.Button(
        root,
        text="Previous",
        command=lambda: (root.destroy(), subprocess.Popen(["python", "build.py"])),
        bg="#ecc474",
        fg="#000000",
